...
<head>
    ...
    <title>Annual Event Status</title>
    <link rel="stylesheet" type="text/css" href="/V/View/globalstyles.css">
    <link rel="stylesheet" type="text/css" href="/V/View/manager/annualeventstatus/annualeventstatus.css">
...
<body>
    <div class="container-background">
        <div class="header">
            <h1 class="header-title">Annual Event Status</h1>
            <p class="header-subtitle">Track approval status of annual events</p>
        </div>
    ...
    <script src="/V/View/manager/annualeventstatus/annualeventstatus.js"></script>
</body>
