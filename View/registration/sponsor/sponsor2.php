...
<body>
  <div class="container">
    ...
    <div class="form-card">
      ...
      <!-- <form> -->
        <form method="POST" action="/V/router.php?module=registration&action=s_registration_step2">
        <div class="form-row">
        ...
        <div class="form-footer">
          ...
          <button type="button" class="btn-previous" 
            onclick="window.location.href='/V/router.php?module=registration&action=s_registration_step1'">
        ← Previous
    </button>
