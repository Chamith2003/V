...
<head>
    <title>V</title>
        <link rel="stylesheet" type="text/css" href="/V/View/sponsor/sponsorship.css">
    ...
    <div class="mainContent">
        ...
        <div class="payment-gateway-container">
            <div class="payment-gateway-card">
                ...
                <!-- Donation Form -->
                <form method="POST" action="/V/router.php?module=sponsorship&action=initiatepayment" id="donationForm">
                ...
                <!-- Hidden fields for payment processing -->
                    ...
                    <div class="payment-form-grid">
                        ...
                        <div class="form-column">
                            ...
                            <div class="form-group">
                                <label>Annual Event</label>
                                <input type="hidden" id="event_id" name="event_id" value="<?= $sponsorEvent['event_id'] ?>">
                                <div class="event-option selected">
                                    <strong><?= htmlspecialchars($sponsorEvent['name']) ?></strong><br>
                                    <small>📅 <?= $sponsorEvent['event_date'] ?>    |     📌 <?= htmlspecialchars($sponsorEvent['location']) ?></small>
                                </div>
                            </div>
                            <?php else: ?>
      ...
      <script src="/V/View/sponsor/sponsorship.js"></script> 
</body>
</html>